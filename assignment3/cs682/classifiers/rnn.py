...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        x, cache_wembed = word_embedding_forward(captions_in, W_embed) # NxTxH
        
        if self.cell_type == 'rnn':
           h, cache_rnn = rnn_forward(x, h0, Wx, Wh, b) # NxTxH
        else:
           h, cache_lstm = lstm_forward(x, h0, Wx, Wh, b) # NxTxH
        out, cache_vocab = temporal_affine_forward(h, W_vocab, b_vocab) # NxTxH
    ...
    def sample(self, features, max_length=30):
        ...
        for i in range(max_length):
            if self.cell_type == 'rnn':
               ...
               next_h, next_c, cache = lstm_step_forward(x, h0, c0, Wx, Wh, b)
               c0 = next_c
